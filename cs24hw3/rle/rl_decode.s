...
find_space_loop:
        ...
        jnc     find_space_not_done       # Check to see if we carried
        add     $256, %ebx                # If we carried, add 256 directly
...
find_space_done:
        ...
        push %rsi                   # push rsi and rdx onto the stack
        push %rdx                   # to avoid being overwritten by
                                    # malloc
